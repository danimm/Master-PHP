            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="initial" type="text"
                                    ...
                                    value="{{ Auth::user()->initial }}" required autocomplete="initial" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="initial" class="col-md-4 col-form-label text-md-right">{{ __('Phone') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postcode" type="text"
                                    ...
                                    value="{{ Auth::user()->postcode }}" autocomplete="postcode" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="place" type="text" class="form-control @error('place') is-invalid @enderror"
                                    name="place" value="{{ Auth::user()->place }}" autocomplete="place" autofocus>
